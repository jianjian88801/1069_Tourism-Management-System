<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="观光日期" prop="guanguangriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.guanguangriqi" 
                type="date"
                placeholder="观光日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.guanguangriqi" label="观光日期" prop="guanguangriqi">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="购买票数" prop="goumaipiaoshu">
          <el-input v-model="ruleForm.goumaipiaoshu" 
              placeholder="购买票数" clearable  :readonly="ro.goumaipiaoshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="购买票数" prop="goumaipiaoshu">
              <el-input v-model="ruleForm.goumaipiaoshu" 
                placeholder="购买票数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="生成订单时间" prop="shengchengdingdanshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.shengchengdingdanshijian" 
                type="datetime"
                placeholder="生成订单时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shengchengdingdanshijian" label="生成订单时间" prop="shengchengdingdanshijian">
              <el-input v-model="ruleForm.shengchengdingdanshijian" 
                placeholder="生成订单时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  data() {
	...
	zongfeiyong : false,
	yonghuming : false,
	shengchengdingdanshijian : false,
	sfsh : false,
	shhf : false,
	ispay : false,
      },
  ...
  computed: {
    zongfeiyong:{
      get: function () {
        return 1*this.ruleForm.gerenpiaojia*this.ruleForm.goumaipiaoshu
      }
    },
  },
  created() {
	this.ruleForm.shengchengdingdanshijian = this.getCurDateTime()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gerenpiaojia = true;
          ...
          if(o=='goumaipiaoshu'){
            this.ruleForm.goumaipiaoshu = obj[o];
	    this.ro.goumaipiaoshu = true;
            continue;
          }
          if(o=='zongfeiyong'){
	    ...
	    this.ro.yonghuming = true;
          ...
          if(o=='shengchengdingdanshijian'){
            this.ruleForm.shengchengdingdanshijian = obj[o];
	    this.ro.shengchengdingdanshijian = true;
            continue;
          }
        }
      }
